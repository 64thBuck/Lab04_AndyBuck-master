...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCounter = (TextView) findViewById(R.id.receiver1);
        myFrequency = (TextView) findViewById(R.id.frequency);
        myVolume = (TextView) findViewById(R.id.Volume1);
...

        {
            ...
            { slider2Value = progress / 100.0f;
                ...
                sendFloatPD("slider2", slider2Value);
    ...
    private PdReceiver Volume1 = new PdReceiver() {
        private void pdPost(final String msg) {
            Log.e("RECEIVED:", msg);
    ...
    private void initPD() throws IOException
    {
        ...
        dispatcher.addListener("sendVolume", Volume1);
